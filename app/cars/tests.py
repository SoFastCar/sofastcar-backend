...
class CarTestCase(APITestCase):
    def setUp(self):
        ...
        # 테스트용 차량 스케쥴 2개
        self.schedule_1 = CarTimeTable.objects.create(car_id=self.cars[0].id,
                                                 date_time_start='2020-09-27T12:00:00+00:00',
                                                 date_time_end='2020-09-27T12:30:00+00:00')
        self.schedule_2 = CarTimeTable.objects.create(car_id=self.cars[0].id,
