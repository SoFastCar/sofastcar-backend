...
class ReservationAlarmSerializer(serializers.Serializer):
    reservation_id = serializers.IntegerField(source='id')
    rental = serializers.SerializerMethodField('get_rental')
    payment = serializers.SerializerMethodField('get_payment')

    def get_rental(self, reservation):
        serializer = RentalSerializer(instance=reservation)
        return serializer.data

    def get_payment(self, reservation):
        serializer = PaymentSerializer(instance=reservation)
        return serializer.data
